...
class SeedlingModbusClient(client):
    ...
    def writecurrentASeedlings(self,val):
        self.write_register(self.regCodes["currentASeedlings"],val)

    def writecurrentBSeedlings(self,val):
        self.write_register(self.regCodes["currentBSeedlings"],val)

    def writecurrentCSeedlings(slef,val):
        self.write_register(self.regCodes["currentCSeedlings"],val)
